...
| objective<br>function                          | objective: Total system costs               | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
|                                                | objective: Emissions                        | 🔴        | 1        | 0     | 1       | 0        | 1        | 0     | 1             | 0        |
|                                                | Weighted multi-objective  function          | 🔴        | 1        | 0     | 1       | 0        | 1        | 0     | 1             | 0        |
| Temporal<br>representation                     | Hourly operation time step                  | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
...
| Technical<br>representation of<br>technologies | Technology agnostic                         | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 🔴        |
...
| Technical<br>representation<br>of storage      | Storage                                     | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
...
| Technical  <br>representation <br>of networks  | Network connections                         | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
...
| Demand  <br>and demand <br>management          | Electricity demand                          | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
...
| Electricity  <br>sale/purchase <br>tariffs     | Purchase - Simple tariff                    | 1        | 1        | 1     | 1       | 1        | 1        | 1     | 1             | 1        |
...
| Targets and <br>constraints                    | Resource cap                                | 1        | 1        | 1     | 1       | 1        | 1        | 0     | 1             | 1        |
...
| Availability <br>and usability                 | open source                                 | 1        | 1        | 1     | 0       | 1        | 1        | 1     | 1             | 1        |
